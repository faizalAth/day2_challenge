...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        List<Product> products=service.getProductsByPlaces("Black Table");
        for(Product product : products){
            System.out.println(product);
        }

        System.out.println("==============================================");
        System.out.println("a Particular Expired Warranty");

        List<Product> expiredProducts=service.getProductsByExpiredWarranty();
